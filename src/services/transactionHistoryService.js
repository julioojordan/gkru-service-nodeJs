class TransactionHistoryService {
  ...
  async findAllWithKeluargaContext(tahun) {
    ...
    try {
      await connection.beginTransaction();
      const result = await this.repository.findAllWithKeluargaContext(
        tahun,
        connection
      );
      await connection.commit();
  ...
  async findAllSetoran(query) {
    ...
    try {
      await connection.beginTransaction();
      const result = await this.repository.findAllSetoran(connection, tahun, bulan);
      await connection.commit();
      return result;
    } catch (error) {
      await connection.rollback();
  ...
  async findAllWithIdKeluarga(query) {
    ...
    try {
      await connection.beginTransaction();
      const result = await this.repository.findAllWithIdKeluarga(
        query.idKeluarga,
        query.tahun,
        connection
      );
